...
console.log("Danh sach nhung san pham co gia lon hon 50$ la: ", lonHon50(products));
...
console.log("Danh sach nhung san pham co danh gia 4 sao tro len: ", bigger4star(products));

//BT3
console.log("-------Bài 3---------");
function womencategory(arr) {
  let lengthArr = arr.length;
  let tempArr = [];
  for (let i = 0; i < lengthArr; i++) {
...
console.log("Danh sach nhung san pham women's clothing: ", womencategory(products));
//BT4
console.log("------Bài 4--------")
function listCategory(arr){
  ...
  let tempArr = [];
  for (let i = 0; i <= lengthArr; i++) {
    if (tempArr.indexOf(arr[i]?.category) === -1) {
      tempArr.push(arr[i]?.category);
    }
  }
  tempArr.pop();
  return tempArr;
...
console.log("Products by type = ",tempArr);
//BT6
console.log("------Bài 6-------");
